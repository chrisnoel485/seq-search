                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div>
                                <h3 class="card-title">Input Letak</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                                ...
                                <div class="col-md-12">
                                    <form action="{{ route('letak.store') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" placeholder="Masukkan Nama Letak" class="form-control" aria-describedby="nama">
                                        </div>
                                        <div class="form-group">
                                            <label for="deskripsi">Deskripsi</label>
                                            <textarea name="deskripsi" id="deskripsi" cols="5" rows="5" placeholder="Masukkan Deskripsi Letak" class="form-control" aria-describedby="deskripsi"></textarea>
                                        </div>
                                        <div class="form-group">
