                                ...
                                <div class="col-md-12">
                                    <form action="{{ route('merek.store') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" placeholder="Masukkan Nama Merek" class="form-control" aria-describedby="nama">
                                        </div>
                                        <div class="form-group">
                                            <label for="deskripsi">Deskripsi</label>
                                            <textarea name="deskripsi" id="deskripsi" cols="5" rows="5" placeholder="Masukkan Deskripsi Merek" class="form-control" aria-describedby="deskripsi"></textarea>
                                        </div>
